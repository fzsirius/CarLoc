    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">CarLoc</a>
                <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link" href="#about">A propos</a></li>
                        <li class="nav-item"><a class="nav-link" href="#services">Comment ça marche ?</a></li>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Leader dans la location des voitures !</h2>
                        <hr class="divider divider-light" />
                        <p class="text-white-75 mb-4">Prenez la route en toute liberté avec notre site de location de voitures ! Nous vous offrons un large choix de modèles de voitures à louer gratuitement et sans engagement. Obtenez rapidement les documents nécessaires et partez à l'aventure sans contraintes ! Louer une voiture n'a jamais été aussi facile !</p>
                        <a class="btn btn-light btn-xl" href="#services">Comment ça marche ?</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="page-section" id="services">
            <div class="container px-4 px-lg-5">
                <h2 class="text-center mt-0">Avec CarLoc, c'est :</h2>
                <hr class="divider" />
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Des voitures sûres</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-laptop fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Disponibles</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-globe fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Trouvable en ligne</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/a.jpg"  >
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/b.jpg" >
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/e.jpg" >
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/f.jpg">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <!-- Message de réussite de soumission-->
                            <!---->
                            <!-- C'est ce que nos utilisateurs verront lorsque le formulaire-->
                            <!-- aura été soumis avec succès -->
                            <div class="d-none" id="submitSuccessMessage">
                                <div class="text-center mb-3">
                                    <div class="fw-bolder">Soumission du formulaire réussie !</div>
                                   <p> Formulaire à activer plus tard............
                                    voir :
                            ...
                            <!---->
                            <!-- C'est ce que nos utilisateurs verront lorsqu'il y a -->
                            <!-- une erreur lors de la soumission du formulaire -->
                            <div class="d-none" id="submitErrorMessage"><div class="text-center text-danger mb-3">Erreur d'envoi de message!</div></div>
                            <!-- Bouton de soummission-->
    ...
    <footer class="footer-distributed">
        ...
        <div class="footer-center">
            ...
            <div>
                ...
                <p><a href="mailto:tcherekarim@gmail">tcherekarim@gmail.com</a></p>
            </div>
        </div>
        <div class="footer-right">
            <p class="footer-company-about">
                <span>A propos</span>
                <strong>CarLoc</strong> est un site web de location de voiture. Vous trouverez tous les voitures que vous voulez à des prix raisonnables.                           Vous pouvez nous suivre sur nos réseaux sociaux.
            </p>
      ...
      <center><p class="footer-company-name">Copyright © 2023 <strong>CarLoc</strong> All rights reserved</p></center>
    </footer>
